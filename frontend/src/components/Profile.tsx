...
export default function Profile() {    
    ...
    const fetchUserData = (id: any, token: any) => {
        mfaapi.get(`api/users/getuserid/${id}`,{headers: {
    ...
    const submitProfile = (event: any) => {
        ...
        mfaapi.patch(`api/users/updateprofile/${userid}`, jsondata, { headers: {
            Authorization: `Bearer ${token}`
        }})
        .then((res: any) => {
    ...
    const changePicture = (event: any) => {
        event.preventDefault();
            ...
            api.patch(`api/users/uploadpicture/${userid}`, formData, {headers: {
                Authorization: `Bearer ${token}`
            }})
            .then((res: any) => {
                setProfileMsg(res.data.message);
    ...
    const enableMFA = () => {
        ...
        mfaapi.patch(`api/users/mfa/activate/${userid}`, data, {headers: {
            Authorization: `Bearer ${token}`
        }})
        .then((res: any) => {
            setProfileMsg(res.data.message);
    ...
    const disableMFA = () => {
        ...
        mfaapi.patch(`api/users/mfa/activate/${userid}`, jsonData, {headers: {
            Authorization: `Bearer ${token}`
        }})
        .then((res: any) => {
            setProfileMsg(res.data.message);
    ...
    const changePassword = (event: any) => {
        ...
        mfaapi.patch(`api/users/changepassword/${userid}`, jsonData, {headers: {
            Authorization: `Bearer ${token}`
        }})
        .then((res: any) => {
                setProfileMsg(res.data.message);
